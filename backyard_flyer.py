...
class BackyardFlyer(Drone):
    ...
    def calculate_box(self):
        ...
        """
        all_waypoints = [(10, 0), (10, 10), (0, 10), (0, 0)]
        # self.all_waypoints = all_waypoints
        print('calculate_box:{}'.format(all_waypoints))
    ...
    def waypoint_transition(self):
        ...
        for point in self.all_waypoints:
            print(point)
            self.cmd_position(point[0],
                             point[1],
